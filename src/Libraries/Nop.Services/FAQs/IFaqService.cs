...
public interface IFaqService
{
    ...
    Task<List<Faq>>                 GetAllFaqsAsync(List<int> categoryIds, string productName = "");
    ...
    Task<List<Faq>>                 GetAllFaqsByProductNameAsync(string productName);
    Task<List<Faq>>                 GetAllFaqByProductsIdsAsync(ICollection<int> productIds);
    Task<List<Faq>>                 GetAllFaqsByIdsAsync(ICollection<int> faqIds);
    Task<List<Faq>>                 GetAllFaqsByCategoryIdsAsync(ICollection<int> categoryIds);
}